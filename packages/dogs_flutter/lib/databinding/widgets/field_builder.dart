...
class _FieldBindingBuilderState<T extends FieldBindingController>
    extends State<FieldBindingBuilder<T>> {
  T? controller;
  ...
  void didChangeDependencies() {
    ...
    if (widget.fieldName != null) {
      ...
      if (resolvedController is! T) {
        throw ArgumentError(
          "Controller for field '$fieldName' is not of type ${T.runtimeType} but ${resolvedController.runtimeType}",
        );
      }
