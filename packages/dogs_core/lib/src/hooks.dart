...
abstract class SerializationHook implements StructureMetadata {
  ...
  void postSerialization(
      dynamic obj, Map<String, dynamic> map, DogStructure structure, DogEngine engine) {}
...
mixin FieldSerializationHook on StructureMetadata {
  ...
  void postFieldSerialization(NativeStructureContext context,
      NativeStructureFieldContext fieldContext, Map<String, dynamic> map, DogEngine engine) {}

  /// This method is called before a field is deserialized by [NativeSerializerMode].
  void beforeFieldDeserialization(NativeStructureContext context,
      NativeStructureFieldContext fieldContext, Map<String, dynamic> map, DogEngine engine) {}
}
