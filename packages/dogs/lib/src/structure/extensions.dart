...
extension StructureExtensions on DogStructure {
  ...
  List<dynamic Function(dynamic)> get getters => List.generate(fields.length, (index) => (obj) => this.proxy.getField(obj, index));
...
extension FieldExtension on DogStructureField {
  ...
  DogConverter? findConverter() {
    if (converterType == null) {
      return dogs.findAssociatedConverter(serialType);
    } else {
