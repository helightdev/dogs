...
class _NargsTreeBaseConverterFactory<BASE> extends TreeBaseConverterFactory {
  ...
  DogConverter getConverter(TypeTree tree, DogEngine engine, bool allowPolymorphic) {
    ...
    if (tree.arguments.length != nargs) throw ArgumentError("Expected $nargs type arguments");
    var factory = switch (tree.arguments.length) {
      1 => tree.arguments.first.qualified.consumeType(captureFactory as Function<_>()),
