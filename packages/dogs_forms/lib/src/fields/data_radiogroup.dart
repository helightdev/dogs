...
/// A [AutoFormFieldFactory] that creates [FormBuilderRadioGroup]s.
class DataRadioGroupFormFieldFactory extends AutoFormFieldFactory {
  ...
  /// A [AutoFormFieldFactory] that creates [FormBuilderRadioGroup]s.
  const DataRadioGroupFormFieldFactory(this.providerKey);
