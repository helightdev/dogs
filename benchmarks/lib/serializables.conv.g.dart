...
class DogPersonConverter extends gen.DefaultStructureConverter<gen1.DogPerson> {
  @override
  final gen.DogStructure<gen1.DogPerson> structure =
      const gen.DogStructure<gen1.DogPerson>(
          'DogPerson',
          ...
          [],
          gen.ObjectFactoryStructureProxy<gen1.DogPerson>(
              _activator, [_name, _age, _tags], _values));
  ...
  static List<dynamic> _values(gen1.DogPerson obj) =>
      [obj.name, obj.age, obj.tags];
