...
class DogBenchmarkDataclassEntityConverter extends gen.DefaultStructureConverter<gen2.DogBenchmarkDataclassEntity> {
  @override
  final gen.DogStructure<gen2.DogBenchmarkDataclassEntity> structure = const gen.DogStructure<gen2.DogBenchmarkDataclassEntity>(
      ...
      [
        ...
        gen.DogStructureField(gen0.Map<gen0.String, gen0.String>, gen.TypeToken<gen0.Map<gen0.String, gen0.String>>(), null, gen.IterableKind.none, 'fields', false, true, [gen1.polymorphic])
      ],
      [],
...
extension DogBenchmarkDataclassEntityDogsExtension on gen2.DogBenchmarkDataclassEntity {
  ...
  DogBenchmarkDataclassEntity builder(Function(DogBenchmarkDataclassEntityBuilder builder) func) {
    var builder = DogBenchmarkDataclassEntityBuilder(this);
    func(builder);
    return builder.build();
  }

  DogBenchmarkDataclassEntity rebuild(Function(DogBenchmarkDataclassEntityBuilder b) f) {
    var builder = DogBenchmarkDataclassEntityBuilder(this);
    f(builder);
    return builder.build();
  }
